...
def url_gen_func(logger_name, start_date,end_date):
    ...
    df['date_vec'] = df['date_vec'].replace("-", "/",regex=True)
...
host = 'hawaii-meso-live-db-do-user-14120648-0.b.db.ondigitalocean.com'
port = 25060
database = 'met-live'
...
if __name__ == '__main__':
    ...
    # sta_qry = "SELECT * FROM station_data WHERE id = 143;"
